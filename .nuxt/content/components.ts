...
export const localComponentLoaders = {
  ...
  BlogPost: () => import("./../../app/components/blogPost.vue").then(m => pickExport(m, "default", "BlogPost", "./../../app/components/blogPost.vue")),
